...
// 첫 문제 로드
loadQuiz();
// 예상 문제 예시를 바탕으로 퀴즈 데이터 생성
const quizData = [
    {
        question: "자바스크립트에서 변수를 선언하는 키워드가 아닌 것은?",
        choices: ["var", "let", "const", "int"],
        answer: 3
    },
    {
        question: "HTML의 기본 구조에 포함되지 않는 것은?",
        choices: ["<head>", "<body>", "<footer>", "<main>"],
        answer: 2
    },
    {
        question: "CSS에서 글자색을 지정하는 속성은?",
        choices: ["color", "background", "font-size", "border"],
        answer: 0
    },
    {
        question: "다음 중 배열의 길이를 반환하는 자바스크립트 프로퍼티는?",
